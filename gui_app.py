...
class ULNFormatterApp:
    def __init__(self, root):
        ...
        btn_prompt_side = tk.Button(sidebar, text="📜 Xem / Sửa AI Prompt...", command=self.open_prompt_editor, bg="#0284c7", fg="#ffffff", font=("Segoe UI", 9, "bold"), relief="flat", pady=4)
        btn_prompt_side.pack(fill="x", pady=(6, 2))
